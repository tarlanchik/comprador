            ...
            <div class="card-body">
                <div class="row g-2 align-items-start">
                    @foreach($locales as $lang=>$label)
                        <div class="col-md-3">
                            <input type="text" wire:model="form.name_{{ $lang }}" class="form-control" placeholder="Название категории ({{$label}})">
            ...
            <div class="card-footer">
                <div class="col">
                    <button type="submit" class="btn btn-{{ $isEditing ? 'warning' : 'primary'}} float-end">
                        @if($isEditing) <i class="bi bi-pencil-square"></i> Обновить @else <i class="bi bi-folder-plus"></i> Добавить @endif
                    </button>
                    @if($isEditing)
